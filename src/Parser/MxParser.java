...
public class MxParser extends Parser {
    ...
    public static final int
            ...
            RULE_ctrlStatement = 24, RULE_condition = 25, RULE_branchStatement = 26,
            RULE_whileStatement = 27, RULE_forInit = 28, RULE_forInitCondition = 29,
            RULE_forStatement = 30, RULE_returnStatement = 31;
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                ...
                "classBody", "classDef", "varDeclareUnit", "varDef", "newArrayExpr",
                "newClassExpr", "newExpression", "exprStatement", "ctrlStatement", "condition",
                "branchStatement", "whileStatement", "forInit", "forInitCondition", "forStatement",
                "returnStatement"
        };
    }
    ...
    public final CtrlStatementContext ctrlStatement() throws RecognitionException {
        ...
        enterRule(_localctx, 48, RULE_ctrlStatement);
        int _la;
        try {
            enterOuterAlt(_localctx, 1);
            {
